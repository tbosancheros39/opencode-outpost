...
export const ru: I18nDictionary = {
  ...
  "cmd.description.digest": "Краткий обзор контекста текущей сессии",
  "cmd.description.find": "Семантический поиск по истории сессии",
  "cmd.description.pin": "Закрепить файлы в контексте",
  "cmd.description.resume": "Восстановить из снапшота",
  "cmd.description.snapshot": "Сохранить контекст сессии в SQLite",
  ...
  "cmd.pin.usage_remove": "Использование: /pin remove <путь>",
  "cmd.pin.button_clear_all": "🧹 Очистить всё",
  ...
  // === Snapshot Command ===
  "cmd.snapshot.deleted": "Снапшот удалён: {id}",
  "cmd.snapshot.empty": "Снапшоты для этой сессии не найдены.",
  "cmd.snapshot.error_delete": "Не удалось удалить снапшот.",
  ...
  "cmd.snapshot.saved": "Снапшот сохранён: {name}\nID: {id}",
  "cmd.snapshot.usage_delete": "Использование: /snapshot delete <id>",
  "cmd.snapshot.usage_load": "Использование: /snapshot load <id>",
  ...
  // === Digest Command ===
  "cmd.digest.empty": "Нет сообщений для обобщения.",
  ...
  "status.health.healthy": "Здоров",
  "status.health.unhealthy": "Не здоров",
  "status.health.checking": "Проверка...",
