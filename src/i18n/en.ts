export const en = {
  ...
  "cmd.description.digest": "Context summary of current session",
  "cmd.description.find": "Semantic search across session history",
  "cmd.description.pin": "Pin files to context",
  "cmd.description.resume": "Restore from snapshot",
  "cmd.description.snapshot": "Save session context to SQLite",

  // === Find Command ===
  "cmd.find.error": "Failed to search session history.",
  ...
  "cmd.pin.already_pinned": "File is already pinned: {path}",
  "cmd.pin.button_clear_all": "🧹 Clear All",
  "cmd.pin.button_refresh": "🔄 Refresh",
  "cmd.pin.callback_invalid_index": "Invalid file index.",
  "cmd.pin.cleared": "All pinned files cleared.",
  "cmd.pin.empty": "No pinned files. Use /pin <filepath> to pin a file.",
  "cmd.pin.error_add": "Failed to pin file.",
  "cmd.pin.error_clear": "Failed to clear pinned files.",
  "cmd.pin.error_is_directory": "Cannot pin a directory as a file: {path}",
  ...
  "cmd.pin.removed": "Removed pinned file: {path}",
  "cmd.pin.usage_add": "Usage: /pin add <filepath>",
  "cmd.pin.usage_remove": "Usage: /pin remove <filepath>",

  // === Snapshot Command ===
  "cmd.snapshot.deleted": "Snapshot deleted: {id}",
  "cmd.snapshot.empty": "No snapshots found for this session.",
  "cmd.snapshot.error_delete": "Failed to delete snapshot.",
  ...
  "cmd.snapshot.saved": "Snapshot saved: {name}\nID: {id}",
  "cmd.snapshot.usage_delete": "Usage: /snapshot delete <id>",
  "cmd.snapshot.usage_load": "Usage: /snapshot load <id>",
  ...
  "cmd.resume.select_page": "Select a snapshot to resume (page {page}):",
  "cmd.resume.session_not_found": "Session not found: {id}",
  "cmd.resume.success": "Session resumed: {title}\nFrom snapshot: {name}",

  // === Digest Command ===
  "cmd.digest.empty": "No messages to summarize.",
