...
export const fr: I18nDictionary = {
  ...
  "cmd.description.digest": "Résumé du contexte de la session actuelle",
  "cmd.description.find": "Recherche sémantique dans l'historique des sessions",
  "cmd.description.pin": "Épingler des fichiers au contexte",
  "cmd.description.resume": "Restaurer depuis un snapshot",
  "cmd.description.snapshot": "Sauvegarder le contexte de session dans SQLite",
  ...
  "cmd.pin.usage_remove": "Utilisation : /pin remove <filepath>",
  "cmd.pin.button_clear_all": "🧹 Tout effacer",
  ...
  // === Snapshot Command ===
  "cmd.snapshot.deleted": "Snapshot supprimé : {id}",
  "cmd.snapshot.empty": "Aucun snapshot trouvé pour cette session.",
  "cmd.snapshot.error_delete": "Échec de la suppression du snapshot.",
  ...
  "cmd.snapshot.saved": "Snapshot sauvegardé : {name}\nID : {id}",
  "cmd.snapshot.usage_delete": "Utilisation : /snapshot delete <id>",
  "cmd.snapshot.usage_load": "Utilisation : /snapshot load <id>",
  ...
  "bot.session_reset_to_global": "Session réinitialisée par défaut global",

  "tts.enabled": "🔊 Synthèse vocale activée",
