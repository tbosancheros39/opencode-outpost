...
export const zh: I18nDictionary = {
  ...
  "cmd.description.digest": "当前会话的上下文摘要",
  "cmd.description.find": "跨会话历史的语义搜索",
  "cmd.description.pin": "将文件固定到上下文",
  "cmd.description.resume": "从快照恢复",
  "cmd.description.snapshot": "将会话上下文保存到 SQLite",

  // === Find Command ===
  "cmd.find.error": "搜索会话历史失败。",
  ...
  // === Pin Command ===
  "cmd.pin.added": "已添加固定文件：{path}",
  "cmd.pin.already_pinned": "文件已固定：{path}",
  "cmd.pin.cleared": "已清除所有固定文件。",
  "cmd.pin.empty": "没有固定文件。使用 /pin <filepath> 固定文件。",
  "cmd.pin.error_add": "固定文件失败。",
  "cmd.pin.error_clear": "清除固定文件失败。",
  "cmd.pin.error_is_directory": "无法将目录作为文件固定: {path}",
  ...
  "cmd.pin.usage_add": "用法：/pin add <filepath>",
  "cmd.pin.usage_remove": "用法：/pin remove <filepath>",
  "cmd.pin.button_clear_all": "🧹 全部清除",
  ...
  // === Snapshot Command ===
  "cmd.snapshot.deleted": "快照已删除：{id}",
  "cmd.snapshot.empty": "此会话没有快照。",
  "cmd.snapshot.error_delete": "删除快照失败。",
  "cmd.snapshot.error_list": "列出快照失败。",
  "cmd.snapshot.error_load": "加载快照失败。",
  "cmd.snapshot.error_save": "保存快照失败。",
  "cmd.snapshot.error_name_too_long": "快照名称过长。最多100个字符。",
  "cmd.snapshot.info": "快照：{name}\nID：{id}\n会话：{session}\n日期：{date}",
  "cmd.snapshot.list_header": "📸 会话快照：",
  "cmd.snapshot.list_page": "📸 会话快照（第 {page} 页）：",
  "cmd.snapshot.no_session": "没有活动会话。请先使用 /new 创建会话。",
  "cmd.snapshot.not_found": "快照未找到：{id}",
  "cmd.snapshot.prev_page": "上一页",
  "cmd.snapshot.next_page": "下一页",
  "cmd.snapshot.saved": "快照已保存：{name}\nID：{id}",
  "cmd.snapshot.usage_delete": "用法：/snapshot delete <id>",
  "cmd.snapshot.usage_load": "用法：/snapshot load <id>",

  // === Resume Command ===
  "cmd.resume.error": "恢复会话失败。",
  "cmd.resume.no_snapshots": "没有快照。请先使用 /snapshot 保存一个。",
  "cmd.resume.prev_page": "上一页",
  "cmd.resume.next_page": "下一页",
  "cmd.resume.select": "选择要恢复的快照：",
  "cmd.resume.select_page": "选择要恢复的快照（第 {page} 页）：",
  "cmd.resume.session_not_found": "会话未找到：{id}",
  "cmd.resume.success": "会话已恢复：{title}\n来自快照：{name}",

  // === Digest Command ===
  "cmd.digest.empty": "没有消息可摘要。",
  "cmd.digest.error": "生成摘要失败。",
  "cmd.digest.generating": "正在生成会话摘要...",
  "cmd.digest.header": "# 会话摘要：{title}\n\n",
  "cmd.digest.no_session": "没有活动会话。请先使用 /new 创建会话。",
